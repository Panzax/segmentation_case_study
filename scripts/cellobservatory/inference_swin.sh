...
export PYTHONPATH="/clusterfs/nvme/martinalvarez/GitHub/segmentation_case_study:/clusterfs/nvme/martinalvarez/GitHub/segmentation_case_study/cell_observatory_platform:/clusterfs/nvme/martinalvarez/GitHub/segmentation_case_study/monai${PYTHONPATH:+:${PYTHONPATH}}"
...
python cell_observatory_finetune/manager.py --config-name=experiments/abc/inference/test_inference_swin_unetr.yaml
